...
const Footer = () => {
  return (
    <div className=" w-full flex h-screen bg-zinc-900 rounded-tl-3xl rounded-tr-3xl p-[5.5vw] font-['Founders_Grotesk Text'] font-semibold ">
      <div className=" w-1/2 h-full flex flex-col justify-between ">
        <div className="heading ">
          <h1 className="text-[5vw] uppercase -mb-2 tracking-tighter leading-none">
            EYE -
          </h1>
          <h1 className="text-[5vw] uppercase -mb-2 tracking-tighter leading-none">
            OPENING
      ...
      <div className="w-1/2 uppercase ">
        <h1 className="text-[5vw] uppercase mb-50">presentations</h1>
        <div className="details flex flex-col font-['Neue_Montreal'] font-light mt-[1.5vw]">
